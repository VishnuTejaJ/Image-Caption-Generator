...
def get_loader(
    ...
    if mode == "train":
        ...
        img_folder = f'{cocoapi_loc}/images/train2017'
        annotations_file = f'{cocoapi_loc}/annotations/captions_train2017.json'
    elif mode == "test":
        ...
        img_folder = f'{cocoapi_loc}/images/test2017'
        annotations_file = f'{cocoapi_loc}/annotations/image_info_test2017.json'
    elif mode == "valid":
        assert batch_size == 1, "Please change batch_size to 1 if testing the model."
        assert os.path.exists(
            vocab_file
        ...
        assert vocab_from_file, "Change vocab_from_file to True."
        img_folder = f'{cocoapi_loc}/images/val2017'
        annotations_file = f'{cocoapi_loc}/annotations/captions_val2017.json'
    else:
...
class CoCoDataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        if self.mode == "train":
            ...
            image = Image.open(f'{self.img_folder}/{path}').convert("RGB")
            ...
            pil_image = Image.open(f'{self.img_folder}/{path}').convert("RGB")
